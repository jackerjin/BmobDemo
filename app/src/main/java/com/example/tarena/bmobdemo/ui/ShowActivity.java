...
import com.example.tarena.bmobdemo.Receiver.MyREceiver;
...
public class ShowActivity extends Activity {
    ...
    private void initListView() {
        dates=new ArrayList<>();
        adapter=new PostAdapter(this,dates,user);
    ...
    protected void onResume() {
        ...
        filter.addAction("COM.TARENA.JIN");
    ...
    public class MyPostReceiver extends BroadcastReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ("COM.TARENA.JIN".equals(action)){
